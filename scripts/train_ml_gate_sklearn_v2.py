...
MODEL_PATH = ARTIFACTS / "ml_gate_sklearn_v2.joblib"
REPORT_PATH = REPORTS / "ml_gate_sklearn_v2_metrics.json"

WIB = timezone(timedelta(hours=7))

CAT_FEATURES = [
    "symbol_norm", "direction_norm", "priority", "mode",
    "source_mode", "execution_decision", "reject_gate",
...
def main():
    ...
    metrics = {
        "model_version": "sklearn_logreg_v2",
