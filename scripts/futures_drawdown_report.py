...
def main():
    ...
    # Approx start wallet = current wallet - all realized net income in period.
    # Ini realized-equity curve, bukan full mark-to-market historical.
